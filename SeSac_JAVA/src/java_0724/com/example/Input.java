...
public class Input {
    ...
    public Input(List<StudentVO> array) throws FileNotFoundException, FileNotFoundException {
        this.sc = new java.util.Scanner(new java.io.File("C:\\Users\\MZC-USER\\Downloads\\sungjuk_utf8.txt"));
        this.list = array;
    }
